#' saeHB.gpois : Small Area Estimation using Hierarchical Bayesian Method under Generalized Poisson Distribution
#'
#' Provides several functions and datasets for area level of Small Area Estimation using Hierarchical Bayesian Method under Generalized Poisson Distribution. For the reference, see Rao and Molina (2015) <doi:10.1002/9781118735855> and Wang (2021) <doi:10.1016/j.ecoinf.2021.101301>.
#'
#' @section Author(s):
